...
interface PropertyPoliciesProps {
  ...
  onUpdate: (values: PropertyPoliciesProps["initialValues"]) => void;
}
...
const PropertyPolicies: React.FC<PropertyPoliciesProps> = ({
  ...
  // State for pet and smoking policies
  ...
  //       additionalPolicies,
  //     });
  //   }, [petPolicy, smokingPolicy, noisePolicy, guestPolicy, additionalPolicies]);
  ...
  // Handle additional policy change
      ...
      <Grid container spacing={2} sx={{ mt: 2 }}>
        ...
        <Grid size={{ xs: 12 }}>
          ...
          {/* {petPolicy === "restricted" && (
            <TextField
              value="Cats and small dogs (under 25 lbs) allowed with $500 pet deposit and $50/month pet rent. Maximum 2 pets per unit."
              fullWidth
              variant="outlined"
              disabled
              sx={{ mt: 1 }}
        ...
        <Grid size={{ xs: 12 }}>
          ...
          {/* {smokingPolicy === "none" && (
            <TextField
              value="This is a non-smoking property. Smoking is not permitted anywhere on the premises, including balconies and common areas."
              fullWidth
              variant="outlined"
              disabled
              sx={{ mt: 1 }}
